...
function Features() {
  ...
  return (
      ...
      <div><a href="#"><h2 class="text-cyan-900 text-xl text-center font-medium mb-2 underline hover:decoration-4">Events</h2></a>
...
<div class="flex justify-center">
  <div class="rounded-lg shadow-lg bg-white max-w-xs">
    ...
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2">Event 3</h5>
      <p class="text-gray-700 text-base mb-4">
        Some quick example text to build on the card title and make up the bulk of the card's
        content.
      </p>
...
<div><a href="#"><h3 class="text-cyan-900 text-xl font-medium mb-2 text-center underline hover:decoration-4">News</h3></a>
<div class="flex justify-center">
  <div class="rounded-lg shadow-lg bg-white max-w-xs">
    <a href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">
      <img class="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/182.jpg" alt=""/>
    ...
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2">News 1</h5>
      <p class="text-gray-700 text-base mb-4">
        Some quick example text to build on the card title and make up the bulk of the card's
        content.
      </p>
...
<div class="flex justify-center">
  <div class="rounded-lg shadow-lg bg-white max-w-xs">
    ...
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2">News 2</h5>
      <p class="text-gray-700 text-base mb-4">
        Some quick example text to build on the card title and make up the bulk of the card's
        content.
      </p>
...
<div class="flex justify-center">
  <div class="rounded-lg shadow-lg bg-white max-w-xs">
    ...
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2">News 3</h5>
      <p class="text-gray-700 text-base mb-4">
        Some quick example text to build on the card title and make up the bulk of the card's
        content.
      </p>
  ...
  <div><a href="#"><h3 class="text-cyan-900 text-xl font-medium mb-2 text-center underline hover:decoration-4">Notes</h3></a>
  <div class="flex justify-center">
  <div class="rounded-lg shadow-lg bg-white max-w-xs">
    <a href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">
      <img class="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/182.jpg" alt=""/>
    ...
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2">Note 1</h5>
      <p class="text-gray-700 text-base mb-4">
        Some quick example text to build on the card title and make up the bulk of the card's
        content.
      </p>
...
<div class="flex justify-center">
  <div class="rounded-lg shadow-lg bg-white max-w-xs">
    ...
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2">Note 2</h5>
      <p class="text-gray-700 text-base mb-4">
        Some quick example text to build on the card title and make up the bulk of the card's
        content.
      </p>
...
<div class="flex justify-center">
  <div class="rounded-lg shadow-lg bg-white max-w-xs">
    ...
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2">Note 3</h5>
      <p class="text-gray-700 text-base mb-4">
        Some quick example text to build on the card title and make up the bulk of the card's
        content.
      </p>
      <button type="button" class=" inline-block px-6 py-2.5 bg-cyan-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-cyan-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Read</button>
      <div class="card-actions justify-end">
      <div class="badge badge-outline"><a href="#">Mehmet Epidemir</a></div> 
    </div>
    </div>
  </div>
</div>
